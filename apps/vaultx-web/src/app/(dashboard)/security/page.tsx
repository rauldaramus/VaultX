...
export default function SecurityPage() {
  return (
    <div className="space-y-8 animate-fade-in-up opacity-0">
      ...
      >
        <h1 className="text-3xl font-bold transition-colors duration-300 hover:text-primary">Security</h1>
        <p className="text-muted-foreground transition-colors duration-200 hover:text-foreground">Manage your account security settings.</p>
      </div>
      ...
      <Tabs defaultValue="security-config" className="w-full">
        ...
        >
          <TabsTrigger value="security-config">Security Configuration</TabsTrigger>
